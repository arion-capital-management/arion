view: vw_exacta_wager {
  sql_table_name: dbo.vwExactaWager ;;
  ...
  dimension: _primary_program_number1 {
    type: string
    sql: ${TABLE}._primary_program_number1 ;;
  }

  dimension: _primary_program_number2 {
    type: string
    sql: ${TABLE}._primary_program_number2 ;;
  }
  ...
  dimension: _program_number1 {
    type: string
    sql: ${TABLE}._program_number1 ;;
  }
